...
import os
from utils.BBBConvmodel_nobias import BBBAlexNet, BBBLeNet, BBB3Conv3FC, BBBVGG16, BBBVGG19
...
torch.save(model, "../results/vgg16_nobias_b{}_lr{}_{}.pth".format(batch_size, lr, dataset))
